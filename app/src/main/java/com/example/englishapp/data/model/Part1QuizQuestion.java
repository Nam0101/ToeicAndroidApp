...
public class Part1QuizQuestion implements Parcelable, QuizQuestion{
    ...
    protected Part1QuizQuestion(Parcel in) {
        id = in.readString();
        tende = in.readString();
        cau = in.readString();
        anh = in.readString();
    ...
    public static final Creator<Part1QuizQuestion> CREATOR = new Creator<Part1QuizQuestion>() {
        @Override
        public Part1QuizQuestion createFromParcel(Parcel in) {
            return new Part1QuizQuestion(in);
        }

        @Override
        public Part1QuizQuestion[] newArray(int size) {
            return new Part1QuizQuestion[size];
        }
    };
