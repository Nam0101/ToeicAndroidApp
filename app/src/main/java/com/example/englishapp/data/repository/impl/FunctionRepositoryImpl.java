...
public class FunctionRepositoryImpl implements FunctionRepository {
    ...
    public ArrayList<Function> getFunctions() {
        ...
        functionsArray.add(new Function(4, "Từ mới", "https://i.imgur.com/h7F71cK.png"));
        functionsArray.add(new Function(5, "Tài khoản", "https://i.imgur.com/14PTDQ0.png"));
        functionsArray.add(new Function(6, "Đăng xuất", "https://i.imgur.com/62Bzmyp.png"));
