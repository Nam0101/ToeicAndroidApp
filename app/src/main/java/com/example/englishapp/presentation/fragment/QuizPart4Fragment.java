...
import com.example.englishapp.databinding.FragmentPart4QuizBinding;
...
public class QuizPart4Fragment  extends Fragment {
    ...
    FragmentPart4QuizBinding binding;
    public static QuizPart4Fragment newInstance(QuizQuestion question, int position) {
        QuizPart4Fragment fragment = new QuizPart4Fragment();
        Bundle args = new Bundle();
        Part4QuizQuestion part4QuizQuestion = (Part4QuizQuestion) question;
        args.putParcelable("question", part4QuizQuestion);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPart4QuizBinding.inflate(inflater, container, false);
        setupRadioButtons();
        setupSeekBar();
    ...
    private void setupPlayPauseButton() {
        Part4QuizQuestion part4QuizQuestion = (Part4QuizQuestion) question;
        Log.i("QuizPart4Fragment", "setupPlayPauseButton: " + part4QuizQuestion.toString());
        if(part4QuizQuestion.getAnh() != null) {
            Future<File> future = CacheManager.cacheImageFile(getContext(), part4QuizQuestion.getAnh());
            try{
        ...
        binding.buttonPlayMusic.setOnClickListener(v -> {
            Log.i("QuizPart4Fragment", "setupPlayPauseButton: " + part4QuizQuestion.getAmthanh());
            if (mediaPlayer == null) {
                mediaPlayer = new MediaPlayer();
                try {
                    String mp4Url =  BuildConfig.BASE_URL + part4QuizQuestion.getAmthanh();
                    Log.i("QuizPart4Fragment", "setupPlayPauseButton: " + mp4Url);
